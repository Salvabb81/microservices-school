package com.salva.microservicios.app.examenes.controllers;
...
import com.salva.microservicios.app.examenes.services.ExamenService;
...
import com.salva.microservicios.commons.examenes.models.entity.Pregunta;
...
public class ExamenController extends CommonController<Examen, ExamenService>{
	...
	public ResponseEntity<?> editar(@Valid @RequestBody Examen examen, BindingResult result, @PathVariable Long id){
		...
		examenDb.setAsignaturaMadre(examen.getAsignaturaMadre());
