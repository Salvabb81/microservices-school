package com.salva.microservicios.app.cursos.controllers;
...
import com.salva.microservicios.app.cursos.services.CursoService;
...
public class CursoController extends CommonController<Curso, CursoService> {
	...
	public ResponseEntity<?> searchCursoByAlumnoId(@PathVariable Long id){
